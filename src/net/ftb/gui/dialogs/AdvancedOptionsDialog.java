...
public class AdvancedOptionsDialog extends JDialog {
	...
	public AdvancedOptionsDialog() {
		...
		lblMinecraftWindowSize.setBounds(10, 45, 170, 25);
		add(lblMinecraftWindowSize);

		minecraftY = new JTextField();
		minecraftY.setBounds(317, 45, 95, 25);
		...
		lblX_1.setBounds(297, 45, 15, 25);
		add(lblX_1);

		JLabel lblMinecraftWindowPosition = new JLabel("Minecraft Window Position:");
		lblMinecraftWindowPosition.setBounds(10, 80, 170, 25);
		add(lblMinecraftWindowPosition);

		xPosField = new JTextField();
		xPosField.setBounds(190, 80, 95, 25);
		...
		label.setBounds(297, 80, 15, 25);
		add(label);

		yPosField = new JTextField();
		yPosField.setBounds(317, 80, 95, 25);
		...
		autoMaxCheck.setBounds(10, 115, 170, 25);
		...
		exitBtn.setBounds(150, 150, 140, 28);
